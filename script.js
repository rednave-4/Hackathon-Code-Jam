...
function startStage(stageId) {
  ...
  document.getElementById('story-stage-label').textContent = 'BABAK 01 · RENGASDENGKLOK';
  updateStatsUI();
...
function renderScene(sceneId) {
  ...
  document.getElementById('speaker-name').textContent = scene.speaker || 'Narator';
  ...
  document.getElementById('story-hint').textContent =
    (scene.choices && scene.choices.length) ? 'Pilih salah satu opsi di atas' : '';
}
...
function showEnding(endingScene) {
  document.getElementById('ending-badge').textContent = endingScene.badge;
  document.getElementById('ending-title').textContent = endingScene.title;
  document.getElementById('ending-desc').textContent = endingScene.desc;
