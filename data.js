...
/* Timeline nodes (year scale for Learn Mode timeline view) */
PJ.TIMELINE = [
  { id: "sumpah-pemuda", year: 1928, month: 10, day: 28 },
  { id: "rengasdengklok", year: 1945, month: 8, day: 16 },
  { id: "proklamasi", year: 1945, month: 8, day: 17 },
  { id: "surabaya", year: 1945, month: 11, day: 10 },
...
PJ.GLOSSARY = [
  {
    term: { id: "Proklamasi", en: "Proclamation" },
    def: {
      id: "Pembacaan teks kemerdekaan Indonesia pada 17 Agustus 1945 oleh Soekarno–Hatta yang menandai lahirnya Republik Indonesia.",
      en: "The reading of Indonesia's independence text on 17 August 1945 by Soekarno–Hatta, marking the birth of the Republic.",
    },
  },
  {
    term: { id: "Sumpah Pemuda", en: "Youth Pledge" },
    def: {
      id: "Ikrar 28 Oktober 1928: satu tanah air, satu bangsa, satu bahasa Indonesia — fondasi persatuan nasional.",
      en: "The 28 October 1928 pledge: one homeland, one nation, one Indonesian language — a foundation of national unity.",
    },
  },
  {
    term: { id: "Rengasdengklok", en: "Rengasdengklok" },
    def: {
      id: "Kota di Karawang tempat golongan muda membawa Soekarno–Hatta pada 16 Agustus 1945 agar proklamasi segera dilaksanakan.",
      en: "A town in Karawang where young activists took Soekarno–Hatta on 16 August 1945 to push for an immediate proclamation.",
    },
  },
  {
    term: { id: "Golongan Muda", en: "Young Group" },
    def: {
      id: "Aktivis muda yang mendesak proklamasi segera setelah Jepang menyerah, tanpa menunggu keputusan pihak lain.",
      en: "Young activists who pressed for an immediate proclamation after Japan's surrender, without waiting on other powers.",
    },
  },
  {
    term: { id: "BPUPKI", en: "BPUPKI" },
    def: {
      id: "Badan Penyelidik Usaha-usaha Persiapan Kemerdekaan Indonesia; merumuskan dasar negara dan rancangan UUD.",
      en: "Investigating Committee for Preparatory Work for Independence; drafted the state foundation and constitution.",
    },
  },
  {
    term: { id: "PPKI", en: "PPKI" },
    def: {
      id: "Panitia Persiapan Kemerdekaan Indonesia; mengesahkan proklamasi dan membentuk struktur pemerintahan awal.",
      en: "Preparatory Committee for Indonesian Independence; ratified the proclamation and formed the early government.",
    },
  },
  {
    term: { id: "Agresi Militer Belanda", en: "Dutch Military Aggression" },
    def: {
      id: "Operasi militer Belanda (1947 dan 1948) untuk merebut kembali wilayah Indonesia setelah proklamasi.",
      en: "Dutch military operations (1947 and 1948) aimed at reclaiming Indonesian territory after the proclamation.",
    },
  },
  {
    term: { id: "Perang Gerilya", en: "Guerrilla War" },
    def: {
      id: "Strategi tempur TNI dan rakyat dengan serangan bergerak, menghindari konfrontasi frontal dengan pasukan yang lebih kuat.",
      en: "TNI and popular warfare using mobile strikes, avoiding frontal battles against stronger forces.",
    },
  },
  {
    term: { id: "PDRI", en: "PDRI" },
    def: {
      id: "Pemerintahan Darurat Republik Indonesia di Sumatera, dipimpin Sjafruddin Prawiranegara saat Yogyakarta diduduki.",
      en: "Emergency Government of the Republic of Indonesia in Sumatra, led by Sjafruddin Prawiranegara while Yogyakarta was occupied.",
    },
  },
  {
    term: { id: "KMB", en: "Round Table Conference" },
    def: {
      id: "Konferensi Meja Bundar di Den Haag (1949) yang berujung pengakuan kedaulatan Indonesia oleh Belanda.",
      en: "The Hague Round Table Conference (1949) that led to Dutch recognition of Indonesian sovereignty.",
    },
  },
  {
    term: { id: "Hari Pahlawan", en: "Heroes' Day" },
    def: {
      id: "Peringatan 10 November untuk menghormati perjuangan rakyat, terutama Pertempuran Surabaya 1945.",
      en: "Commemoration on 10 November honouring the struggle, especially the 1945 Battle of Surabaya.",
    },
  },
  {
    term: { id: "Naskah Proklamasi", en: "Proclamation Text" },
    def: {
      id: "Teks kemerdekaan yang disusun malam 16–17 Agustus 1945 di rumah Laksamana Maeda, dibacakan keesokan harinya.",
      en: "The independence text drafted on the night of 16–17 August 1945 at Admiral Maeda's house, read the next day.",
    },
  },
];
