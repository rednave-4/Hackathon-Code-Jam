...
PJ.UIFx = (function () {
  function burstFromEvent(e, opts) {
    opts = opts || {};
    const duration = opts.duration != null ? opts.duration : 420; // fast
    ...
    for (let i = 0; i < count; i++) {
      ...
      p.style.animationDuration = (0.28 + Math.random() * 0.22).toFixed(2) + "s";
  ...
  return { init: init, burstFromEvent: burstFromEvent, playModeEnter: playModeEnter };
})();
